...
- Sử dụng terminal dowload soure code: git clone https://github.com/letronghieubkhn-droid/flappy-bird.git
- Tại terminal: sử dụng câu lệnh sau để makefile: make
- Sau đó trò chơi sẽ được bắt đầu.
- Mọi khó khăn trong phần cài đặt, trong quá trình chơi, hãy email qua email: letronghieubkhn@gmail.com
